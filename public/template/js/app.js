! function(t) {
    ...
    e.prototype.intSlimscrollmenu = function() {
        ...
        this.intSlimscrollmenu(), this.initSlimscroll(), this.initMetisMenu(), this.initLeftMenuCollapse(), this.initEnlarge(), this.initComponents(), this.initFullScreen(), Waves.init()
