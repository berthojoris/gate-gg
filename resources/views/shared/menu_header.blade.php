        ...
        <ul class="navbar-right list-inline float-right mb-0">
            ...
            <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right language-switch">
                    <a class="dropdown-item" href="#"><img src="{{ asset('template/images/flags/germany_flag.jpg') }}" alt="" height="16"><span>German </span></a>
                    <a class="dropdown-item" href="#"><img src="{{ asset('template/images/flags/italy_flag.jpg') }}" alt="" height="16"><span>Italian </span></a>
                    <a class="dropdown-item" href="#"><img src="{{ asset('template/images/flags/french_flag.jpg') }}" alt="" height="16"><span>French </span></a>
